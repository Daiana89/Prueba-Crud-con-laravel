                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span id="card_title">
                             ...
                             <div class="float-right">
                              ...
                              <div class = "float-right">
                                <a href="{{ route('exportarPdf') }}" class="btn btn-sm btn-success">Exportar PDF</a>
                                <a href="{{ route('exportarExc') }}" class="btn btn-sm btn-danger">Exportar EXCEL</a>
                              </div>
                        </div>
                    </div>
